...
var holiday_details_1 = require("./holiday.details");
var app_component_1 = require("./app.component");
var router_1 = require("@angular/router");
var appRoutes = [
    { path: '', component: app_component_1.AppComponent },
    { path: 'holiday/:name', component: holiday_details_1.HolidayDetails }
];
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, holiday_details_1.HolidayDetails],
